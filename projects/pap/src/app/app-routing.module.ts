...
const routes: Routes = [
  ...
  { path: 'ticket-reservation', loadChildren: () => import('./features/ticket-reservation/ticket-reservation.module').then(m => m.TicketReservationModule) },
  { path: 'abandonment-ticket', loadChildren: () => import('./features/abandonment-ticket/abandonment-ticket.module').then(m => m.AbandonmentTicketModule) },
  { path: 'report-ticket', loadChildren: () => import('./features/report-ticket/report-ticket.module').then(m => m.ReportTicketModule) },
  {
    path: '**',
