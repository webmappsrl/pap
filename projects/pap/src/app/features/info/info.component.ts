...
export class InfoComponent {
  ...
  public infoView$ = of({
    ...
    pageBody: this._sanitizer
      .bypassSecurityTrustHtml(`<p style="font-weight: 400;"><strong>PortAPPorta</strong> &egrave; la nuova applicazione <strong>ESA</strong> che rende la Raccolta Differenziata ancora pi&ugrave; semplice per gli utenti dei Comuni serviti da ESA.</p>
    ...
    <p style="font-weight: 400;">ESA Spa &egrave; una Societ&agrave; per Azioni totalmente partecipata da capitale pubblico che si occupa di raccogliere, conferire e trattare rifiuti urbani assimilati agli urbani delle utenze domestiche e non domestiche dei Comuni dell&rsquo;Isola d&rsquo;Elba.</p>
    ...
    <p style="font-weight: 400;"><strong>&ldquo;Pensa differente&rdquo;</strong> &egrave; il claim della campagna di comunicazione ambientale di ESA, per dare un impulso decisivo allo sviluppo della raccolta differenziata dei rifiuti sull&rsquo;Isola d&rsquo;Elba.</p>
